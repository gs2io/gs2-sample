...
{
    public delegate void ChangeStateHandler(AccountMenuStateMachine.State state);
    public delegate void CreateAccountHandler(EzAccount account);
    public delegate void LoginHandler(EzAccount account, GameSession session);
    public delegate void ErrorHandler(Gs2Exception error);
    
    public class AccountMenuStateMachine : StateMachineBehaviour
    {
        public enum State
        {
            Initialize,
